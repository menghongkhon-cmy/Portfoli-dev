...
const I18N = {
  ...
  km: {
    meta: {
      title: "តារា ចាន់ — អ្នកអភិវឌ្ឍន៍គេហទំព័រ Full-Stack",
      description:
        "គេហទំព័រផលការងាររបស់ តារា ចាន់ អ្នកអភិវឌ្ឍន៍គេហទំព័រ Full-Stack មកពីភ្នំពេញ កម្ពុជា ដែលបង្កើតផលិតផលគេហទំព័រលឿន ស្អាត និងប្រើប្រាស់បានល្អ ដោយប្រើ JavaScript, Python និង Flask។",
    },
    nav: {
      home: "ទំព័រដើម",
      about: "អំពីខ្ញុំ",
